...
<div class="auth-page">
    <div class="auth-left">
        <div class="auth-left-content">
            ...
            <img src="<?= htmlspecialchars($basePath . '/public/assets/images/illustrations/recordando.png', ENT_QUOTES, 'UTF-8') ?>" class="hevy-mascot" alt="Mascota Hevy Recordando">
    ...
    <div class="auth-right">
        ...
        <form method="POST" id="form-reset" novalidate action="<?= htmlspecialchars($basePath . '/reset-password', ENT_QUOTES, 'UTF-8') ?>">
